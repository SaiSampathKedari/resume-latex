...
\tagline{\small I am passionate about leveraging optimization, machine learning, control theory, and uncertainty quantification to develop robust, safe, and efficient algorithms for dynamic, uncertain environments, with a keen interest in the mathematical aspects of these fields.}
...
% \cvsection{Objective}
% \begin{itemize}
%     \item Seeking a Research Opportunity in state estimation, dynamics learning, and controls, with a focus on applications for mobile robots.
% \end{itemize}
...
\cvevent{}{Literature Review : Prof. Alex Gorodetsky \href{https://drive.google.com/file/d/1RkUaKzeyvz4vG0zyT5cfK_vOzAU-4TTz/view?usp=drive_link}{\textbf{(Project Report)}} \href{https://drive.google.com/file/d/1XukVD8PcuhjwbzoHYmLOx7Em8Y0Q46XF/view?usp=drive_link}{(\textbf{PPT})}}{Jan'2024 - May'2024}{University of Michigan, Ann Arbor}
\begin{itemize}
...
\cvevent{}{Directed Study: Prof. Dimitra Panagou}{Jan'2024 - Ongoing}{University of Michigan, Ann Arbor}
\begin{itemize}
...
\cvevent{}{Machine Learning Course Project}{Aug'2022 - Dec'2022}{University of Michigan, Ann Arbor}
\begin{itemize}
